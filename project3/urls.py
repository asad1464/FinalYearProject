...
urlpatterns = [
    ...
    # path('pricepredict/',user.pricepredict, name='pricepredict'),
    path('pricepredictions/', user.pricepredictions, name='pricepredictions'),
    path('inputdisplay/', user.inputdisplay, name='inputdisplay'),
    path('inputdisplay/price/<id>',user.price, name='price'),
    path('analysisreport/',user.analysisreport,name='analysisreport'),
